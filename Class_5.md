...
|**Practice Computing Similarity of Sentence Embeddings To Find Similar Movies**|1) use a pre-trained model to evaluate the cosine similarity of a dataset of movies based on their descriptions 2) practice using SBERT and computing the cosine similarity on a movie dataset for different queries.|[![Open in Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/matsunagateitoku/stdp-class/blob/main/class_5/class_5/Find_Movies.ipynb)|
