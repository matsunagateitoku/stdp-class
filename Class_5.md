...
|**Use Levenshtein Distance To Autocorrect Text**|built-in Python-Levenshtein package & NLTK implementation of edit distance  timeit function in conjunction with the Brown Corpus dictionary to offer recommendations for reducing the total number of computations and runtime|
