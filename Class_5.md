...
|**Practice Computing Similarity of Sentence Embeddings To Find Similar Movies**|1) use a pre-trained model to evaluate the cosine similarity of a dataset of movies based on their descriptions 2) practice using SBERT and computing the cosine similarity on a movie dataset for different queries.|
